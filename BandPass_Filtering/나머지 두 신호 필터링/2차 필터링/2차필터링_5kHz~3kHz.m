...
% 음성 파일 읽기
[x, fs] = audioread('c:/test/lastFilter_Downward.wav');
...
% 결과 음성 파일로 저장
output_file = 'c:/test/testing/Extracted_Frequency_Signal_3000to5000.wav';
audiowrite(output_file, new_signal, fs);

% 음성 파일 읽기
[x, fs] = audioread('c:/test/testing/Extracted_Frequency_Signal_3000to5000.wav');
